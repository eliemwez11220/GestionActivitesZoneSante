...
<html>
    <head>
        ...
        <title><?= (!empty($title) ? $title: "dashboard"); ?> | TshamilembaActivity Application</title>
        <!-- favicon
        ============================================ -->
    ...
    <body class="hold-transition skin-danger sidebar-mini">
        <div class="wrapper">
            <header class="main-header">
                <!-- Logo -->
                <a href="" class="logo">
                    <!-- mini logo for sidebar mini 50x50 pixels -->
                    <span class="logo-mini">TSHAMILEMBA</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg">TSHAMILEMBA</span>
                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="#">
                                <i class="fa fa-ambulance"></i> <span>Centre Tshamilemba</span>
                            </a>
                            <ul class="treeview-menu">
                               
                                <li>
                                    <a href="<?php echo site_url('activite/index');?>"><i class="fa fa-list-ul"></i> Activites agents</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('campagne/index');?>"><i class="fa fa-book"></i> Nos campagnes</a>
                                </li>
                                 <li>
                                    <a href="<?php echo site_url('vaccin/index');?>"><i class="fa fa-address-book-o"></i> Vaccination</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="#">
                                <i class="fa fa-users"></i> <span>Agents & Centres</span>
                            </a>
                            <ul class="treeview-menu">
                                 <li>
                                    <a href="<?php echo site_url('agent/index');?>"><i class="fa fa-users"></i> Listing agents</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('centre/index');?>"><i class="fa fa-list-ul"></i> Centres hospitalies</a>
                                </li>
                            </ul>
                        </li>
