...
<head>
    ...
    <title><?= $title ? $title : 'Bienvenue' ?> | TshamilembaActivity Applicattion !</title>
            ...
            <div class="hpanel">
                <div class="panel-body">
                    <div class="text-center m-b-md custom-login">
                        ...
                        <?php } else { ?>
                            <b>TshamilembaActivity Application</b>!
                ...
                <div class="col-sm-6">
                    <div class="float-left text-left">
                        ...
                        <img src="<?= base_url(); ?>global/img/logo/coding.png"
                            ...
                            | <a href="https://congoagile.com" style="background-color: transparent; color: blue; font-weight: bold;">TshamilembaActivity Application</a>
                        </span>
                         <br>
